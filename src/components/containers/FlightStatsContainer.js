...
const FlightStatsContainer = ({ client }) => (
    <Surface style={[styles.statsContainer, { height: 450 }]}>
        ...
        <View style={{ flexDirection: 'row' }}>
            <Text style={{ flex: 1 }}>
                Flown  <Text style={{ fontSize: 16, color: '#898989' }}>{client.distFlown} nm</Text>
            </Text>
            <Text style={{ flex: 1 }}>
                Remaining  <Text style={{ fontSize: 16, color: '#898989' }}>{client.distRemaining} nm</Text>
            </Text>
        </View>

        <View style={{ flexDirection: 'row' }}>
            <Text style={{ flex: 1 }}>
                ETE  <Text style={{ fontSize: 16, color: '#898989' }}>{client.ete || 'N/A'}</Text>
            </Text>
            <Text style={{ flex: 1 }}>
                ETA  <Text style={{ fontSize: 16, color: '#898989' }}>{client.eta ? client.eta + 'z' : 'N/A'}</Text>
            </Text>
        </View>
