...
const FlightPlanContainer = ({ client }) => (
    <Surface style={styles.statsContainer}>
        ...
        <Text style={{ flex: 1 }}>
            Aircraft  <Text style={{ fontSize: 16, color: '#898989' }}>{client.aircraft}</Text>
        </Text>

        <View style={{ flexDirection: 'row' }}>
            <Text style={{ flex: 1 }}>
                Departure  <Text style={{ fontSize: 16, color: '#898989' }}>{client.plannedDepTime}z</Text>
            </Text>
            <Text style={{ flex: 1 }}>
                Arrival  <Text style={{ fontSize: 16, color: '#898989' }}>{client.plannedArrTime}z</Text>
            </Text>
        </View>
