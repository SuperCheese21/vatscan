    ...
    <View style={styles.infoContainerDetail}>
        <View style={styles.infoRow}>
            <View style={styles.infoRow}>
                ...
                <Text style={styles.infoText}>{props.data.aircraft}</Text>
            </View>
            <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>Flown</Text>
                <Text style={styles.infoText}>{props.data.distFlown}</Text>
            </View>
            <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>Remaining</Text>
                <Text style={styles.infoText}>{props.data.distRemaining}</Text>
            </View>
        </View>
        <View style={styles.infoRow}>
            <View style={styles.infoRow}>
                <Icon name='unfold-more' size={24} color={colors.accent} />
                <Text style={styles.infoText}>{props.data.altitude}</Text>
            </View>
            <View style={styles.infoRow}>
            ...
            <View style={styles.infoRow}>
                ...
                <Text style={styles.infoText}>{props.data.groundSpeed}</Text>
            </View>
        </View>
    </View>
);
